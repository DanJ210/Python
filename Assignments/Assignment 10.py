...
number = 0
sumAll = 0 #In raptor I used "sum", but I should've known it was used already.
average = 0
count = 0
#Gathering my LCD with an input prompt so I can add their first values of the prompt.
...
while(number != -1):
    ...
    number = float(input("Please Enter Next Positive Decimal Number: "))
else:
